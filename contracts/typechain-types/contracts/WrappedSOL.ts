...
export interface WrappedSOLInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface WrappedSOL extends BaseContract {
  connect(runner?: ContractRunner | null): WrappedSOL;
  waitForDeployment(): Promise<this>;

  interface: WrappedSOLInterface;
